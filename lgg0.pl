...
polygon(object_1).	% object is instanciated regardless of its specific properties
polygon(object_2).	% object is instanciated regardless of its specific properties

ellipsoid(object_1).	% object is instanciated regardless of its specific properties
ellipsoid(object_2).	% object is instanciated regardless of its specific properties
